  ...
  navbarPage(theme = "layout.css",
    ...
    tabPanel("All clusters", # padding-top: 70px
      ...
      div(class = "jumbotron", id = "welcome",
        ...
        div(id = "displayCode", style = "text-align: center", h4(code)    ),
          fluidRow(
            column(6,
              div(id = "clusterTable",
                ...
                hr(),
                div(
                  shinycssloaders::withSpinner(DT::dataTableOutput("all_clusters"))
                )
              )
            ),
            ### CLUSTER VIEW
            column(6,
              div(id="clusterView",
                ...
                div(
                  shinycssloaders::withSpinner(plotOutput("select_cluster_plot", width = "100%") )
                ),
      ...
      #
        ...
        verticalLayout(fluid=TRUE,
          div(id="geneView",
            ...
            hr(),
            div(id="genePlot",
              shinycssloaders::withSpinner(plotOutput("select_gene_plot", width="100%", height = "300px"))
              ),
            hr(),
            div(class = "download_btn",
